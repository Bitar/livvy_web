export const stagingPages = [
    ...
    {
        title: 'Style Quiz Intro',
        image: 'https://storage.googleapis.com/livvy-app/staging-pages-screenshots/style-quiz-take-quiz.png',
        link: '/style-quiz/',
        needAuth: true
    },
    {
        title: 'Style Quiz',
        image: 'https://storage.googleapis.com/livvy-app/staging-pages-screenshots/style-quiz-questions.png',
        link: '/style-quiz/quiz',
        needAuth: true
    },
    {
        title: 'Style Quiz Confirm Style',
        image: 'https://storage.googleapis.com/livvy-app/staging-pages-screenshots/style-quiz-confirm-style.png',
        link: '/style-quiz/confirm-style',
        needAuth: true
    },
    {
        title: 'Style Quiz Results',
        image: 'https://storage.googleapis.com/livvy-app/staging-pages-screenshots/style-quiz-results.png',
    ...
    {
        title: 'About',
        image: 'https://storage.googleapis.com/livvy-app/staging-pages-screenshots/about.png',
        link: '/about',
        needAuth: true
    }
]