...
export const LivModal: FC<Props> = ({children}) => {
    ...
    return (
        <div onAnimationEnd={() => {
            ...
            <div className={clsx('fixed top-0 left-0 overflow-y-scroll sm:overflow-y-hidden sm:absolute z-40 sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 h-full w-full sm:h-auto sm:w-4/5 lg:w-auto bg-white px-8 sm:px-12' +
                ' py-8')}>
